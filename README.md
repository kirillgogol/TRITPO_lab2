...
![Окно входа в приложение](C:\Users\USER\Downloads\1.PNG)  
...
2. Профиль пользователя хранится в файле с расширением XML, название файла совпадает с именем (псевдонимом)4;
